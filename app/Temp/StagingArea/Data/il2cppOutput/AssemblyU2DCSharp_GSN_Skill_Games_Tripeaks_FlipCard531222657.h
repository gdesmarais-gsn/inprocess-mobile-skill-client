...
{
public:
	// System.Collections.Generic.List`1<System.Int32> GSN.Skill.Games.Tripeaks.FlipCardEvent::cardIndices
	List_1_t1440998580 * ___cardIndices_0;

public:
	inline static int32_t get_offset_of_cardIndices_0() { return static_cast<int32_t>(offsetof(FlipCardEvent_t531222657, ___cardIndices_0)); }
...
#endif
// Native definition for P/Invoke marshalling of GSN.Skill.Games.Tripeaks.FlipCardEvent
struct FlipCardEvent_t531222657_marshaled_pinvoke
{
	List_1_t1440998580 * ___cardIndices_0;
};
// Native definition for COM marshalling of GSN.Skill.Games.Tripeaks.FlipCardEvent
