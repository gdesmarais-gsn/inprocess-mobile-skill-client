...
Shader "SilverTree/Screen Space (Text) (ZTest)" {
	Properties {
...
float4 frag (v2f i) : COLOR
{
	...
	//return float4(_Color.xyz * texcol.r, texcol.g * _Color.w); // black outline
	//return float4(_Color.xyz * texcol.r + fixed3(0.7, 0.2, 0.05), texcol.g * _Color.w); // red outline
	//return float4(_Color.xyz * texcol.r + fixed3(0.0, 0.125, 0.1875), texcol.g * _Color.w); // blue outline
	//return float4(_Color.xyz * texcol.r + fixed3(0.125, 0.275, 0.1), texcol.g * _Color.w); // green outline
}
ENDCG
