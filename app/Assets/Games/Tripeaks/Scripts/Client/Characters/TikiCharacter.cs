...
{
	public class TikiCharacter : MonoBehaviour {
		...
		public const string TIKI_ANNOUNCEMENT_SHOW = "announcement_show";
		public const string TIKI_ANNOUNCEMENT_EXIT = "announcement_exit";
