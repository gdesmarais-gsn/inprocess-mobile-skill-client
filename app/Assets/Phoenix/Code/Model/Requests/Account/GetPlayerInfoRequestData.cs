...
{
	// NOTE: This class uses the same set of data as AccountLoginRequestData. Just a different URL.  It returns a full user object.

	public class GetPlayerInfoRequestData : WebPOSTRequest<AccountLoginData>, IUserInfo
	{
		private const APIReference.Category API_CATEGORY = APIReference.Category.Account;
		private const string URL_KEY = "get_player_data";
